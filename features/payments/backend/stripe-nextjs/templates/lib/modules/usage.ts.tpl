...
export const UsageService = {
  // Usage tracking
  trackUsage: trackOrganizationUsage,
  getUsage: getOrganizationUsage,
  getUsageByMetric: getOrganizationUsageByMetric,
  ...
  create: async (organizationId: string, usage: any) => {
    return trackOrganizationUsage(organizationId, usage);
  },
  
  update: async (organizationId: string, usage: any) => {
    return trackOrganizationUsage(organizationId, usage);
  },
  
  delete: async (organizationId: string) => {
    // Usage tracking doesn't support deletion
    throw new Error('Usage tracking does not support deletion');
  }
};
