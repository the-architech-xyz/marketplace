...
function generateCoreActions(): BlueprintAction[] {
  return [
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src.hooks}use-query.ts',
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src.hooks}use-mutation.ts',
    ...
    // Create Error Boundary for Queries - ALL FRONTEND (React Query works on React Native)
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.apps.frontend.components}QueryErrorBoundary.tsx',
    ...
    // Create Loading States - ALL FRONTEND (React Query works on React Native)
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.apps.frontend.components}QueryLoading.tsx',
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src.types}query.ts',
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src.hooks}use-query-invalidation.ts',
...
function generateInfiniteActions(): BlueprintAction[] {
  return [
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src.hooks}use-infinite-query.ts',
...
function generateOptimisticActions(): BlueprintAction[] {
  return [
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src}optimistic-updates.ts',
...
function generateOfflineActions(): BlueprintAction[] {
  return [
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src}offline-support.ts',
