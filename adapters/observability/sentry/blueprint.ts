...
export default function generateBlueprint(
  ...
  return [
    // Core Sentry client configuration
    {
      ...
      path: '${paths.packages.shared.src}monitoring/sentry/client.ts',
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src}monitoring/sentry/server.ts',
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src}monitoring/sentry/config.ts',
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src}monitoring/sentry/analytics.ts',
    ...
    {
      type: BlueprintActionType.CREATE_FILE,
      path: '${paths.packages.shared.src}monitoring/sentry/performance.ts',
