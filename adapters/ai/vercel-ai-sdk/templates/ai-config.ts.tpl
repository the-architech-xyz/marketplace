...
export const AI_CONFIG = {
  ...
  // Feature flags
  features: {
    streaming: {{module.parameters.features?.streaming ?? true}},
    chat: {{module.parameters.features?.chat ?? true}},
    textGeneration: {{module.parameters.features?.textGeneration ?? true}},
    imageGeneration: {{module.parameters.features?.imageGeneration ?? false}},
    embeddings: {{module.parameters.features?.embeddings ?? false}},
    functionCalling: {{module.parameters.features?.functionCalling ?? false}},
  },
